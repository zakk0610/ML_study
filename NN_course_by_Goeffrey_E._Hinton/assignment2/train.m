...
word_embedding_weights = init_wt * randn(vocab_size, numhid1); % : 250*50
embed_to_hid_weights = init_wt * randn(numwords * numhid1, numhid2); % : 3x50*200
hid_to_output_weights = init_wt * randn(numhid2, vocab_size); % : 200*250
hid_bias = zeros(numhid2, 1); % : 200*1
output_bias = zeros(vocab_size, 1); % : 250

word_embedding_weights_delta = zeros(vocab_size, numhid1); % : 250*50
word_embedding_weights_gradient = zeros(vocab_size, numhid1); % : 250*50
embed_to_hid_weights_delta = zeros(numwords * numhid1, numhid2); % : 3x50*200
hid_to_output_weights_delta = zeros(numhid2, vocab_size); % : 200*250
hid_bias_delta = zeros(numhid2, 1); % : 200*1
output_bias_delta = zeros(vocab_size, 1); % : 250*1
expansion_matrix = eye(vocab_size); % : 250
count = 0;
tiny = exp(-30);
...
% embedding_layer_state : 150*100
% hidden_layer_state : 200*100
% output_layer_state : 250*100
    ...
    % BACK PROPAGATE.
    %% OUTPUT LAYER.
% hid_to_output_weights : 200*250
% error_deriv : 250*100
% back_propagated_deriv_1 : 200*100
...
% back_propagated_deriv_1 : 200*100
% embedding_layer_state : 150*100
% embed_to_hid_weights_gradient : 150*200
    % Options:
...
% embed_to_hid_weights: 150*200
% back_propagated_deriv_1 : 200*100
% back_propagated_deriv_2 = 150*100
    % Options
