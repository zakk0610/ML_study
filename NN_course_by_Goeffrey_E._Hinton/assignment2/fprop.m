...
%     index k of the vocabulary. (i=1~3)
%
...
[numwords, batchsize] = size(input_batch); % 3*100
[vocab_size, numhid1] = size(word_embedding_weights); % 250*50
...
%inputs_to_hidden_units : 200*100
